...
if ( ( (anytim2tai(hd.date_obs) gt anytim2tai('2013/11/06T18:25:00')) AND $
       (anytim2tai(hd.date_obs) lt anytim2tai('2013/11/06T18:35:00')) )     OR $
     ( (anytim2tai(hd.date_obs) gt anytim2tai('2013/11/28T17:04:00')) AND $
       (anytim2tai(hd.date_obs) lt anytim2tai('2013/11/28T20:24:00')) ) ) then begin
    info.details[0].bit_rate = [8.0, 0.01]
    info.details[1].bit_rate = [8.0, 0.01]
    info.details[2].bit_rate = [8.0, 0.01]
    info.details[3].bit_rate = [8.0, 0.01]
    info.details[4].bit_rate = [8.0, 0.01]
    info.details[5].bit_rate = [8.0, 0.01]
    info.details[6].bit_rate = [8.0, 0.01]
endif
